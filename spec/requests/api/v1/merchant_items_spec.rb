  ...
  let(:valid_headers) {
    ...
    describe "GET /index" do
      ...
      it "renders a successful response" do
        get api_v1_merchant_items_url(@merchant), headers: valid_headers, as: :json
      ...
      it "renders all merchant's items" do
        get api_v1_merchant_items_url(@merchant), headers: valid_headers, as: :json
        expect(response).to be_successful
        body = JSON.parse(response.body, symbolize_names: true)
        expect(body[:data].size).to eq(3)
        expect(body[:data].first[:id].to_i).to eq(Item.first.id)
      end

      it "renders status 404 for nil merchant" do
        get '/api/v1/merchants/3312/items', headers: valid_headers, as: :json
        expect(response).to have_http_status(404)
      end

      describe "Get /most_items" do
        it "fetch top 8 items by merchant sold" do
          @merchant1 = Merchant.create(name: 'Crystal r Us')
          ...
          @invoice2 = Invoice.create(customer: @customer, merchant: @merchant1, status: 'shipped')
          @invoice3 = Invoice.create(customer: @customer, merchant: @merchant1, status: 'shipped')
          @invoice4 = Invoice.create(customer: @customer, merchant: @merchant1, status: 'shipped')
          @invoice5 = Invoice.create(customer: @customer, merchant: @merchant2, status: 'shipped')
          @invoice6 = Invoice.create(customer: @customer, merchant: @merchant2, status: 'shipped')
          @invoice7 = Invoice.create(customer: @customer, merchant: @merchant2, status: 'shipped')
          @invoice8 = Invoice.create(customer: @customer, merchant: @merchant2, status: 'shipped')
          @invoice9 = Invoice.create(customer: @customer, merchant: @merchant3, status: 'shipped')
          @invoice10 = Invoice.create(customer: @customer, merchant: @merchant3, status: 'shipped')
          @invoice11 = Invoice.create(customer: @customer, merchant: @merchant3, status: 'shipped')
          @invoice12 = Invoice.create(customer: @customer, merchant: @merchant3, status: 'shipped')
          @invoice13 = Invoice.create(customer: @customer, merchant: @merchant4, status: 'shipped')
          @invoice14 = Invoice.create(customer: @customer, merchant: @merchant4, status: 'shipped')
          @invoice15 = Invoice.create(customer: @customer, merchant: @merchant4, status: 'shipped')
          @invoice16 = Invoice.create(customer: @customer, merchant: @merchant4, status: 'shipped')
          @invoice17 = Invoice.create(customer: @customer, merchant: @merchant5, status: 'shipped')
          @invoice18 = Invoice.create(customer: @customer, merchant: @merchant5, status: 'shipped')
          @invoice19 = Invoice.create(customer: @customer, merchant: @merchant5, status: 'shipped')
          @invoice20 = Invoice.create(customer: @customer, merchant: @merchant5, status: 'shipped')
          @invoice21 = Invoice.create(customer: @customer, merchant: @merchant6, status: 'shipped')
          @invoice22 = Invoice.create(customer: @customer, merchant: @merchant6, status: 'shipped')
          @invoice23 = Invoice.create(customer: @customer, merchant: @merchant6, status: 'shipped')
          @invoice24 = Invoice.create(customer: @customer, merchant: @merchant6, status: 'shipped')
          @invoice25 = Invoice.create(customer: @customer, merchant: @merchant7, status: 'shipped')
          @invoice26 = Invoice.create(customer: @customer, merchant: @merchant7, status: 'shipped')
          @invoice27 = Invoice.create(customer: @customer, merchant: @merchant7, status: 'shipped')
          @invoice28 = Invoice.create(customer: @customer, merchant: @merchant7, status: 'shipped')
          @invoice29 = Invoice.create(customer: @customer, merchant: @merchant8, status: 'shipped')
          @invoice30 = Invoice.create(customer: @customer, merchant: @merchant8, status: 'shipped')
          @invoice31 = Invoice.create(customer: @customer, merchant: @merchant8, status: 'shipped')
          @invoice32 = Invoice.create(customer: @customer, merchant: @merchant8, status: 'shipped')
          ...
          get '/api/v1/merchants/most_items?quantity=8', headers: valid_headers, as: :json
          expect(response).to be_successful
          body = JSON.parse(response.body, symbolize_names: true)
          expect(body[:data].class).to eq(Array)
          ...
          get '/api/v1/merchants/most_items?quantity=1', headers: valid_headers, as: :json
          expect(response).to be_successful
          body = JSON.parse(response.body, symbolize_names: true)
          expect(body[:data].class).to eq(Array)
          ...
          get '/api/v1/merchants/most_items?quantity=100000', headers: valid_headers, as: :json
          expect(response).to be_successful
          body = JSON.parse(response.body, symbolize_names: true)
          expect(body[:data].class).to eq(Array)
          expect(body[:data].size).to eq(8)
